...
export default function Hero() {
  // 使用useMemo缓存随机位置，依赖数组为空确保只生成一次
  const dotPositions = useMemo(() => generateRandomPositions(30), []);

  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      {/* BG */}
      <div className="absolute inset-0">
        <img src="/hero-bg.jpg" alt="Hero" className="w-full h-full object-cover opacity-50" />
          ...
          <div className="space-y-8">
            <div className="animate-fade-in">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-sm text-primary">
                ...
                Full Stack Engineer · Cloud Native Specialist
              </span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-300">
                Hi, I'm JoeyWong - a software engineer specializing in Go and Cloud Native, React
                and TypeScript. I build scalable, performant web application that users love.
              </p>
            </div>
